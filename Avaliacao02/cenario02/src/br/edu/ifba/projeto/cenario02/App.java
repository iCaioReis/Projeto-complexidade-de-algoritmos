package br.edu.ifba.projeto.cenario02;
...
import br.edu.ifba.projeto.cenario02.borda.impl.GeradorDeDadosImpl;
import br.edu.ifba.projeto.cenario02.nuvem.impl.ExecutorImpl;
...
public class App {
    ...
    private static Map<Filial, Map<Veiculo, Float>> filiaisEficiencia = new TreeMap<>();
    ...
    public static Map<Filial, Map<Veiculo, List<LeituraVeiculo>>> gerarFiliais() throws InterruptedException {
        ...
        for (Map.Entry<Filial, GeradorDeDadosImpl> entry : filialVeiculos.entrySet()){
            ...
            filiaisEficiencia.put(filial, dados.getVeiculosComEficiencia());
        }
        return filiais;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        executor.exibirEficiencia(filiaisEficiencia);
    }
}